...
if __name__ == "__main__":
    realisations, xy_len, x_min_var, x_max_var, y_min_var, y_max_var = 5000, 1000, 0.1, 100, 0.1, 100
    
    data, labels = create_data(realisations, xy_len, x_min_var, x_max_var, y_min_var, y_max_var)

    path = f"jakob_mix/data/realisations={realisations}_xy_len={xy_len}_x_min_var={x_min_var}_x_max_var={x_max_var}_y_min_var={y_min_var}_y_max_var={y_max_var}"
